...
set ROOT "/home/tutel/SOC_UVM/cheshire"

if {[catch { vlog -incr -sv \
    -suppress 2583 -suppress 13314 -timescale 1ns/1ps -sv \
...
# ELF Loader (C++ DPI)
vlog "/home/tutel/SOC_UVM/verif/../cheshire/target/sim/src/elfloader.cpp" \
	-ccflags "-std=c++11" -cpppath "/usr/bin/g++"
